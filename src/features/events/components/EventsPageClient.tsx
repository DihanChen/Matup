...
import type { Court, CourtWithDistance } from "@/features/courts/types";
...
function EventsContent() {
  ...
  const filteredCourts = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      result = result.filter(
        (court) =>
          ...
          court.description?.toLowerCase().includes(queryLower) ||
    ...
    return result;
  }, [courts, searchQuery, userLocation, sortByDistance]);
          ...
          <div className="px-5 pt-8 pb-0 flex-shrink-0">
            <div className="mb-5">
              ...
              <p className="text-zinc-400 text-sm mt-1">
                {loading ? "Searching..." : `Found ${activeCount} matches in your vicinity`}
              </p>
            </div>
